...
GOOGLE_EMBEDDINGS = (
    "/dfs/scratch0/gigawordvecs/GoogleNews-vectors-negative300_transformed.txt"
)
# from http://www.cis.lmu.de/~sascha/Ultradense/
TWITTER_EMBEDDINGS = (
    "/dfs/scratch0/gigawordvecs/twitter_lower_cw1_sg400_transformed.txt"
)
...
COHA_EMBEDDINGS = (
    "/dfs/scratch0/COHA/cooccurs/word/ppmi/lsmooth0/nFalse/neg1/cdsTrue/svd/300/50000/"
)
